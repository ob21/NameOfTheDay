...
public class ItemProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse("content://com.obriand.prenomdujour.itemprovider");
	
	public static final String CONTENT_PROVIDER_MIME = "com.obriand.prenomdujour/com.obriand.prenomdujour.item";
	...
	+ Item.ITEM_ORIGIN + " TEXT NOT NULL, " + Item.ITEM_FREQUENCY + " TEXT NOT NULL, " + Item.ITEM_GENDER + " TEXT NOT NULL);"; 
